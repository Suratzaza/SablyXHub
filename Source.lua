	...
	LoadButton.MouseButton1Down:Connect(function()
		if LoadFocus == false then
			...
			repeat wait()
				...
				TitleLoad.Text = "Get Patch Sably X Hub Script Version : 3.0.0"
				wait(0.35)
				TweenService:Create(
					TitleLoad,
					TweenInfo.new(.5, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut),
				...
				TitleLoad.Text = "Welcome to Sably X Hub Script | Premium Edition"
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Sably X Hub Premium Scripts") then
			makefolder("Salad X Hub Premium Scripts")
		end
		if not isfolder("Sably X Hub Premium Scripts/Blox Fruits/") then
			makefolder("Sably X Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("Sably X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Sably X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Sably X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Sably X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Sably X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
-- local CreditL = Page_Credits.Label({Title = "Made By Sably X  Team"})
...
function WebHookLog:WebHookKaiTanSend(WebHookUrl)
	...
	local Embeds = {{
		["title"] = "**Sably X Hub Webhooks Status**",
